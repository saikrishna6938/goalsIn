...
class SearchController {
    constructor() {
        this.SearchDocumentTable = async (req, res) => {
            try {
                ...
                const docType = await documentTypes.findOne({ documentTypeId }, { projection: { documentTypeTableId: 1 } });
                ...
                const dataTable = await dataTables.findOne({ tableId: dataTableId }, { projection: { tableName: 1, fields: 1 } });
                if (!dataTable) {
                ...
                const excludedIds = new Set(taskDocs
