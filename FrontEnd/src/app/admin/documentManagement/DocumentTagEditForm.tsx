...
import LeftPanel from "../formManagement/userform/LeftPanel";
import RenderQuestionFields from "../formManagement/userform/RenderQuestionFields";
import SelectionManager from "../formManagement/userform/Selections";
import QuestionTypeMenuItems from "../formManagement/userform/QuestionTypeMenuItems";
import createEmptyDocumentTemplatefrom from "../formManagement/userform/EmptyForm";
...
const DocumentTagEditForm: React.FC<Props> = ({ Data, onReload, onClose }) => {
  ...
  const handleSave = async () => {
    const reconstructedSections = reconstructOriginalSections();

    const payload = {
      name: Data.name,
      documentTagObjectId: Data.documentTagObjectId,
    ...
    try {
      const response = await api.put(
        `administrator/document-tags/${Data?.documentTagObjectId}`,
        {
          body: payload,
        }
      );
...
export default DocumentTagEditForm;
